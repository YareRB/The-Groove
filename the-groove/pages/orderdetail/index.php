    ...
    <div class="container-fluid margin-t-10 ps-5 pe-5">
        <div class="row  ms-5">
            ...
            <div class="col-11 col-sm-11 col-md-4 col-lg-5 col-xl-5 col-xxl-5 m-t-100 m-s-20 ">
                ...
                <label class="text"> <strong>No. Order:</strong> <label class="ms-3">1</label></label>
                <br>
                <label class="text"> <strong>Total  :</strong> <label class="ms-5">$2400</label></label>

                <h5 class="pt-1 color-gray text mt-2"> Arrived </h5>
                <h4 class="pt-1 title-inter-25 pt-2"> Price: $800</h4>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 col-xxl-3 parent">
                ...
                <img class="img-cart disc" src="./images/after-hours-the-weeknd.svg" alt="">
                <h5 class="color-gray text mt-3 ms-5 ps-4">The weeknd, after hours </h5>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 col-xxl-3 parent">
                <img class="img-disc-cart vinyl" src="./images/vinyl.svg" alt="">
                <img class="img-cart disc" src="./images/after-hours-the-weeknd.svg" alt="">
